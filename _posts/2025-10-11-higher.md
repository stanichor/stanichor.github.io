...
<div style="text-align: center;">
    <figure>
        <img src="/assets/images/one-level-higher/half_means.png" width="400" alt="Line chart showing estimated population level by round across three guessing-game sessions when p equals one half.">
        <img src="/assets/images/one-level-higher/two_thirds_means.png" width="400" alt="Line chart showing estimated population level by round across four guessing-game sessions when p equals two thirds.">
        <img src="/assets/images/one-level-higher/half_medians.png" width="400" alt="Line chart showing estimated median-player level by round across three guessing-game sessions when p equals one half.">
        <img src="/assets/images/one-level-higher/two_thirds_medians.png" width="400" alt="Line chart showing estimated median-player level by round across four guessing-game sessions when p equals two thirds.">
    </figure>
</div>
...
<div style="text-align: center;">
    <figure>
        <img src="/assets/images/one-level-higher/beauty_contest_experiments.png" width="1000" alt="Table summarizing beauty-contest experiments from different studies, including subject pools, mean guesses, winning numbers, and equilibrium values.">
    </figure>
</div>
...
A counter-example has been found, courtesy of Xela. It makes use of the concept of a [meta-stereotype](https://en.wikipedia.org/wiki/Metastereotype). A meta-stereotype is a stereotype that members of one group have about the way they are stereotyped by another group. In other words, it is a stereotype about a stereotype, making it Level 1. Now, for the example:

- Consider the stereotype held by some cis folk that trans women are predators. This is a Level 0 stereotype.
- Now consider the stereotype held by trans women that [cis folk think trans women are predators]. This is a Level 1 stereotype.
- Now consider the stereotype held by some cis folk that [trans women think that [cis folk think that trans women are predators]]. This is a Level 2 stereotype: a meta-meta-stereotype.
- Now, I (a cis man) might hold this Level 2 meta-meta-stereotype. That is, I may think trans women believe that cis folk think trans women are predators, and so I may go out of my way to perform some niceties when interacting with trans women, to reassure them that I *don't* believe the Level 0 stereotype.
- However, consider the stereotype held by some trans women that [cis folk think that [trans women think that [cis folk think that trans women are predators]]]. This is a Level 3 stereotype: a meta-meta-meta-stereotype. A hypothetical trans woman who holds this stereotype might see my performed niceties and recognize them as a performance, making her uncomfortable.
- So, as a self-aware cis person, I might hold the stereotype that [trans women think that [cis folk think that [trans women think that [cis folk think that trans women are predators]]]]. This is a Level 4 stereotype: a meta-meta-meta-meta-stereotype. As a result, I might be wary of my niceties seeming too over-the-top. Instead, I will try to make them seem natural rather than performative.

The fact that there is already an existing concept corresponding to meta-meta-meta-meta-stereotypes—that niceties can come across as performative—is important. It means we're not just adding "meta" levels arbitrarily; these are concepts that ordinary people deal with in everyday life.

In fact, there is a LessWrong post about this broader phenomenon, [*Unrolling social metacognition: Three levels of meta are not enough*](https://www.lesswrong.com/posts/K4eDzqS2rbcBDsCLZ/unrolling-social-metacognition-three-levels-of-meta-are-not). The fact that it also discusses social metacognition seems important. Under the Machiavellian intelligence hypothesis, our intelligence evolved because it provided an advantage in navigating social situations. The fact that we can also use it to build rockets and eradicate diseases is just a fortunate side effect. It would therefore make sense that we are capable of handling more levels of meta in social situations than in other domains.

(Note that our counter-example is at Level 5: we have a stereotype of the self-aware cis person holding a meta-meta-meta-meta-stereotype.)
