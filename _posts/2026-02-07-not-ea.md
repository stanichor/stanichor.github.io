...
<div style="text-align: center;">
    <figure>
        <img src="/assets/images/not-an-ea/ea-forum-emojis.png" width="200" alt="Screenshot of the EA Forum reaction menu showing a small set of reactions such as Agree, Disagree, Heart, Helpful, and Insightful.">
        <img src="/assets/images/not-an-ea/lesswrong-emojis.png" width="238" alt="Screenshot of the LessWrong reaction menu showing a much larger set of reactions, including Changed My Mind, Insightful, Heart, That's a crux, Locally Valid, Concrete, and many others.">
    </figure>
</div>
...
<div style="text-align: center;">
    <figure>
        <img src="/assets/images/not-an-ea/yud.png" width="500" alt="Portrait of Eliezer Yudkowsky wearing a dark hat and glasses against a black background.">
    </figure>
</div>
