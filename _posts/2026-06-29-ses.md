...
[^reflective]: More flexible structural equation models relax this assumption by, for example, including correlated residuals, additional latent variables, cross-loadings, method factors, etc. The important distinction is that a reflective model can determine its parameters from the covariance structure of the indicators, whereas a formative model cannot determine its weights from that covariance structure.
