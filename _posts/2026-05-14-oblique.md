...
There are also many other kinds of response styles with distinctive relationships to intelligence. For example, [acquiescence bias](https://stanichor.net/acquiescence/) (the tendency to agree with items regardless of their content) and extreme responding (the tendency to choose the extremes of a response scale) both show negative correlations with intelligence. In principle, one could measure respondents' intelligence by measuring the extent to which they exhibit these response styles.

## Takeaway

None of these methods are magic. They work because intelligence isn't an isolated trait that only appears in the answers of intelligence tests. It leaks into other behaviors: how people narrow down answer spaces, how internally consistent their responses are, and even what kind of biases they exhibit.

This is both interesting and kind of uncomfortable. Eye movements, questionnaire responses, and response styles aren't usually thought of as measures of intelligence, but they can be used for the same purpose. This raises an obvious question: how far does this generalize? If eye movements, questionnaire responses, and response styles contain this much signal, what about writing style, speech patterns, mouse movements, or the thousands of other small quirks that people have?

Most of these signals are weak. But our world is [inferentially entangled](https://www.lesswrong.com/s/AmFb5xWbPWWQyQ244/p/wyyfFfaRar2jEdeQK): traits leave traces, [traits correlate with other traits](https://gwern.net/everything), and enough weak signals can add up to a strong proxy. If one is smart enough, or simply measures precisely enough, one can infer a great deal of hidden knowledge.
