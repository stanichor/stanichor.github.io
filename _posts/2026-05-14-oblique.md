...
<div style="text-align: center;"> 
    <figure> 
        <img src="/assets/images/oblique/eye-tracking.jpg" alt="Eye-tracking scanpaths for a participant solving two Raven’s Matrices items, showing one item solved mostly by looking at the matrix and another solved by repeatedly looking back and forth between the matrix and response options." width="650"> 
...
<div style="text-align: center;"> 
    <figure> 
        <img src="/assets/images/oblique/mmpi-figure-4.png" alt="Scatterplot of out-of-sample intelligence predictions from MMPI items against measured intelligence test scores, with a LOESS smoothing line and correlation of r = .84." width="650">  
    </figure> 
</div>
...
<div style="text-align: center;"> 
    <figure> 
        <img src="/assets/images/oblique/mmpi-figure-6.png" alt="Line graph showing cross-validated model accuracy as a function of the number of MMPI items included in the model." width="650"> 
    </figure> 
</div>
