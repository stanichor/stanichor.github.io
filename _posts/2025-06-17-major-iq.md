...
related:
  ...
  - /factor-scores/
---
There's this popular chart that's been floating around the internet for years, supposedly showing the average IQ of college students by major.
<div style="text-align: center;">
    <figure>
        <img src="/assets/images/college-major-iq/statistic-brain.jpg" width="200" alt="Chart titled &quot;Average IQ by College Major&quot; listing estimated IQs for majors, with physics, mathematics, and philosophy near the top and education-related majors near the bottom.">
    </figure>
</div>
After investigating, I found that the original data comes from [Statistic Brain][statbrain], which estimated IQ using 2006 GRE scores. The GRE data itself seems accurate, [matching other records from around that time of GRE scores by college major](http://www.kyoolee.net/gre_2005-6_score_chart_and_philosophy_majors.pdf), but the methodology used to convert GRE scores to IQ has two serious errors:
